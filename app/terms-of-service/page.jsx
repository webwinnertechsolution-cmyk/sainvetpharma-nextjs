...
export default function TermsOfServicePage() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/terms-of-service`)
    ...
    <div style={{ background: '#f5f7fa', minHeight: '100vh', fontFamily: "'Nunito',sans-serif" }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .tos-banner-content{position:relative;z-index:2;text-align:center;animation:bannerReveal .7s ease both;}

        .tos-bc-bar{background:#1872B5;padding:10px 0;}
        .tos-bc{max-width:1400px;margin:0 auto;padding:0 24px;font-size:13px;color:rgba(255,255,255,.75);display:flex;align-items:center;gap:4px;flex-wrap:wrap;}
        .tos-bc a{color:rgba(255,255,255,.75);text-decoration:none;transition:color .2s;}
        .tos-bc a:hover{color:#fff;}
        .tos-bc-sep{opacity:.5;margin:0 2px;}
        .tos-bc-cur{color:#fff;font-weight:700;}
        ...
        .tos-section{max-width:1400px;margin:0 auto;padding:56px 24px 60px;}
        ...
        .tos-divider{width:40px;height:3px;background:linear-gradient(135deg,#1872B5,#2596e1);border-radius:2px;}
        ...
        .tos-reveal{opacity:0;}
        .tos-reveal.revealed{animation:fadeUp .7s ease both;}
        ...
        .tos-body ul,.tos-body ol{margin-bottom:14px;padding-left:28px;}
        .tos-body li{font-size:14px;color:#374151;line-height:1.8;margin-bottom:6px;}
        .tos-body strong,.tos-body b{color:#0a214f;font-weight:700;}
        .tos-body a{color:#1872B5;text-decoration:underline;}
        .tos-body a:hover{color:#0a214f;}
...
.tos-header {
    margin-bottom: 24px;
        ...
        @media(max-width:768px){
          ...
          .tos-section{padding:36px 16px 48px;}
          .tos-card{padding:28px 20px;}
          .tos-body h2{font-size:17px;}
          .tos-body h3{font-size:15px;}
		  .tos-banner-content h1 {
    /* font-size: 34px !important; */
    /* font-weight: 700 !important; */
...
.tos-banner {
    height: 121px;
      ...
      <div className="tos-banner">
        <div className="tos-banner-orb" />
        <div className="tos-banner-orb2" />
        <div className="tos-banner-content">
          <h1 style={{
      ...
      {/* Breadcrumb */}
      <div className="tos-bc-bar">
        <nav className="tos-bc">
          <Link href="/">Home</Link>
          <span className="tos-bc-sep">›</span>
          <span className="tos-bc-cur">{page?.heading || 'Terms of Service'}</span>
        </nav>
      </div>
      ...
      <div className="tos-section">
        <div className="tos-header">
          ...
          <h2 className="tos-main-heading">{page?.heading || 'Terms of Service'}</h2>
          <div className="tos-divider" />
        </div>

        <div
          className={`tos-card tos-reveal ${visible ? 'revealed' : ''}`}
